...
grails.plugin.springsecurity.userLookup.authorityJoinClassName = 'digitalcandy.UserRole'
grails.plugin.springsecurity.authority.className = 'digitalcandy.Role'
